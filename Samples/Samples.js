...
var STATIC_BASE = 1024,
    ...
    STACKTOP = STACK_BASE,
    STACK_MAX = 1028960,
    DYNAMIC_BASE = 6271840,
    DYNAMICTOP_PTR = 1028800;
...
var ASM_CONSTS = {
 ...
 717569: function($0) {if (Module['canvas']) { Module['canvas'].style['cursor'] = UTF8ToString($0); } return 0;},  
 717662: function() {if (Module['canvas']) { Module['canvas'].style['cursor'] = 'none'; }},  
 718982: function() {return screen.width;},  
 719009: function() {return screen.height;},  
 719082: function($0) {if (typeof Module['setWindowTitle'] !== 'undefined') { Module['setWindowTitle'](UTF8ToString($0)); } return 0;}
};
...
// {{PRE_LIBRARY}}
  ...
  var ___tm_timezone=(stringToUTF8("GMT", 1028864, 4), 1028864);function _gmtime_r(time, tmPtr) {
